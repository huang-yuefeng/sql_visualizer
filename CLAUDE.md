...
61. **The frame statement-anchor fix + the Class-3 identity unification (v3.3.200 —
    ...
    statement line. Corpus census: 6 swapped frames → 0; blast radius exactly 1 script
    (RFN, 5 rows moved onto own-statement lines); `EXTRACTOR_VERSION 2026-08-28.15`.
    **(b) The Class-3 identity unified**: `_own_occurrence` (:2610 — resolved owner +
    ...
    shortcut and `_own_belongs_to`. Narrowing the column-level VALUE sites to the same

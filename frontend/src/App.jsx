...
const EC = {TABLE_FLOW:'#2ECC71',SCHEMA:'#8AB4F8',ALIAS:'#1ABC9C',REF:'#9AA0A6',AGGREGATE:'#37BC9B',TRANSFORM:'#F0AD4E',WINDOW:'#967ADC',COMPUTED:'#D770AD',INDIRECT:'#5DADE2',DML:'#E74C3C',JOIN:'#E91E63',CORRELATED:'#FF5722',SUBSET:'#E67E22',FILTER:'#3498DB',SET_OP:'#9B59B6'};
...
export default function App() {
  ...
  const load = useCallback(async (s) => {
    ...
    try {
      ...
      setGd(d); setProg({s:'',p:0}); setPanel(null); setShowInfo(true);

...
> Last updated: 2026-09-01 — **v3.3.195 SHIPPED** (release commit `34bd521`, deployed to prod and
...
- A **"(pending release)"** stamp inside an Evidence cell records the state WHEN THAT ROW WAS
  ...
  **v3.3.195** (release commit `34bd521`, 2026-09-01); only the ⏳ rows above are genuinely
  outstanding
